      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end h-full px-6 lg:px-12 pb-20">
          ...
          >
            ...
            <p className="mt-4 text-background/70 text-lg md:text-xl font-body max-w-xl">
              Premium essentials. Built to last. Designed to feel like a second skin.
            </p>
            <Link
              to="/shop"
              className="inline-block mt-8 bg-background text-foreground px-10 py-4 text-sm font-medium uppercase tracking-widest hover:bg-background/90 transition-colors font-body"
            >
              Shop Now
            </Link>
          </motion.div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                <span className="text-2xl font-medium font-body">{formatPrice(featured.price)}</span>
      ...
      <section className="bg-primary text-primary-foreground py-24 px-6 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="font-display text-5xl md:text-7xl mb-6">LESS, BUT BETTER</h2>
            <p className="text-primary-foreground/60 font-body text-lg leading-relaxed max-w-2xl mx-auto">
              We don't do fast fashion. We make one product at a time, and we make it right. 
              100% organic cotton, ethically sourced, built to outlast trends.
            </p>
          </motion.div>
        </div>
      </section>
